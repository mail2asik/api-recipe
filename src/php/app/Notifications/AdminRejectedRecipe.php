...
class AdminRejectedRecipe extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        $mail = (new MailMessage)
                    ->subject('Your Recipe has been rejected  ' . $this->recipe_uid)
                    ->line('Thanks for posting your recipe but Unfortunately Administrator rejected your following recipe.')
